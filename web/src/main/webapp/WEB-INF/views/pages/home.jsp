...
<t:wrapper title="Home" currentItem="1">
    <div class="container_12">
        <div class="grid_6">
            ...
            <div class="p1_box left cl2">
                ...
                <div class="gray_block">
                    Go ahead and read more about this <span class="col1"><a
                        href="http://blog.templatemonster.com/free-website-templates/" rel="nofollow">free theme</a></span> created by
                    TemplateMonster.com.<br>
                    Wide variety of premium <span class="col1"><a
                        href="http://www.templatemonster.com/category/art-photography-website-templates/" rel="nofollow">Art &amp;
                    Photography templates</a></span> is to be found in the same name category at our site.
                </div>
        ...
        <div class="grid_6">
            ...
            <div class="p1_box right cl5">
                <div class="type"></div>
                <blockquote>To me, photography is an art of observation. It’s about finding something interesting in an ordinary
                    place... I’ve found it has little to do with the things you see and everything to do with the way you see them.
                </blockquote>
                <a href="#" class="bot">Elliott Erwitt <span>8 <br>comments</span></a>
            </div>
            <div class="p1_box right cl2">
                <div class="type"></div>
                <img src="<c:url value="/resources/images/page1_img7.jpg"/>" alt="">
